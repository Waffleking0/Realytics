  ...
  const getMetrics = (result: AnalysisResult) => {
    ...
    if (type !== 'land') {
      metrics.push({
        ...
        value: formatCurrency(r.monthlyMortgage ?? 0),
        sentiment: 'neutral' as const,
      ...
      if ((r.grossRent ?? 0) > 0) {
        metrics.push({
          ...
          value: formatCurrency(r.grossRent ?? 0),
          sentiment: 'neutral' as const,
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            {result && (
              <button
                onClick={handleReset}
                className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-gray-500 hover:text-gray-700 border border-gray-300 hover:border-gray-400 rounded-lg transition-colors"
              >
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20 space-y-4">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm mt-1">Running financial calculations, market analysis, and generating AI report</p>
            </div>
          </div>
        )}
