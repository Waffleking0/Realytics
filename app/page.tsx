...
export default function HomePage() {
  return (
    <div className="min-h-screen flex flex-col">
      {/* Navigation */}
      <nav className="border-b border-gray-200 backdrop-blur-sm sticky top-0 z-50 bg-white/80">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-blue-700 rounded-lg flex items-center justify-center">
              <Building2 className="w-5 h-5 text-white" />
            </div>
            <span className="text-xl font-bold text-gray-900">Realytics AI</span>
          </Link>
          <div className="flex items-center gap-3">
            <Link
              href="/auth/signin"
              className="px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 transition-colors hidden sm:block"
            >
              Sign in
            </Link>
            <Link
      ...
      <section className="relative flex-1 flex items-center justify-center px-6 py-24 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight mb-6">
            <span className="text-gray-900">Analyze Any</span>
            <br />
          ...
          <p className="text-lg sm:text-xl text-gray-500 max-w-2xl mx-auto mb-10 leading-relaxed">
            Realytics AI delivers institutional-grade financial modeling, market risk scoring, and
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <Link
              href="/auth/signup"
              className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-semibold rounded-xl text-lg transition-all duration-200 flex items-center gap-2 shadow-lg shadow-blue-500/25"
            >
              Start for free
            ...
            <Link
              href="/analyze"
              className="px-8 py-4 border border-gray-300 hover:border-gray-400 text-gray-600 hover:text-gray-900 font-semibold rounded-xl text-lg transition-colors"
            >
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {propertyTypes.map((type) => (
              <div
                key={type.name}
                className="px-4 py-2 bg-gray-100 border border-gray-300/50 rounded-full text-sm text-gray-600 flex items-center gap-2"
              >
                <span>{type.icon}</span>
                <span>{type.name}</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500 text-lg max-w-2xl mx-auto">
              From raw inputs to a complete investment thesis — Realytics AI handles the math and the analysis.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-500 text-lg mb-8 leading-relaxed">
                Realytics AI automates the financial modeling that institutional investors rely on —
            ...
            <div className="relative">
              <div className="bg-gray-50 rounded-2xl border border-gray-300/50 p-6 shadow-2xl">
                <div className="flex items-center gap-2 mb-4">
                  <div className="w-3 h-3 rounded-full bg-red-500/60" />
                  <div className="w-3 h-3 rounded-full bg-yellow-500/60" />
                  <div className="w-3 h-3 rounded-full bg-green-500/60" />
                  <span className="text-xs text-gray-500 ml-2">Realytics AI — Analysis Dashboard</span>
                </div>
                <div className="grid grid-cols-2 gap-3 mb-4">
                  {[
                    ...
                    <div key={metric.label} className="bg-gray-100 rounded-lg p-3">
                ...
                <div className="bg-gray-100 rounded-lg p-3 flex items-center justify-between">
                  <div>
                    <div className="text-xs text-gray-500 mb-0.5">AI Recommendation</div>
                    <div className="text-sm text-gray-600">Strong fundamentals detected</div>
                  </div>
                ...
                <div className="mt-3 flex items-center gap-2">
                  ...
                  <span className="text-xs text-gray-500">Risk: Low (24/100)</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="px-6 py-20 border-t border-gray-200">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-500 text-lg mb-8">
            Create a free account and get your first analysis in under 30 seconds.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/auth/signup"
              className="inline-flex items-center gap-2 px-10 py-4 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-semibold rounded-xl text-lg transition-all duration-200 shadow-lg shadow-blue-500/25"
            >
              Create free account
              <ArrowRight className="w-5 h-5" />
            </Link>
            <Link href="/pricing" className="text-sm text-gray-500 hover:text-gray-700 underline underline-offset-4">
              View pricing
            </Link>
          </div>
        </div>
      ...
      <footer className="border-t border-gray-200 px-6 py-8">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-gray-500 text-sm">Realytics AI © 2026</span>
          </Link>
