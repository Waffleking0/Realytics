...
export default function RiskScore({ marketAnalysis }: RiskScoreProps) {
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Market Strength */}
      <div className="p-4 bg-gray-100 border border-gray-300/50 rounded-xl">
        <div className="flex items-center justify-between mb-3">
          <p className="text-sm font-medium text-gray-600">Market Strength</p>
      ...
      <div className="space-y-3">
        <p className="text-sm font-semibold text-gray-600">Risk Factors Analysis</p>
