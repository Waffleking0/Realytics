...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  secondary:
    'bg-transparent border border-gray-400 hover:border-blue-500 text-gray-600 hover:text-gray-700 hover:bg-gray-100',
  danger:
    'bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-gray-900 shadow-lg shadow-red-500/20 border border-red-400/20',
  ghost:
