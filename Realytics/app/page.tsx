        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {propertyTypes.map((type) => (
              <div
                key={type.name}
                className="px-4 py-2 bg-white border border-gray-200 rounded-full text-sm text-gray-600 flex items-center gap-2"
              >
                <span>{type.icon}</span>
                <span>{type.name}</span>
              </div>
            ...
            <div className="relative">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-xl">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-xs text-gray-400 ml-2">Analysis Dashboard</span>
                </div>
                <div className="grid grid-cols-2 gap-3 mb-4">
                  {[
                    { label: 'Cap Rate', value: '8.4%', color: 'text-green-600' },
                    { label: 'Cash-on-Cash', value: '11.2%', color: 'text-green-600' },
                    { label: 'Monthly CF', value: '+$1,840', color: 'text-blue-600' },
                    { label: 'IRR (10yr)', value: '16.8%', color: 'text-purple-600' },
                  ].map((metric) => (
                ...
                <div className="bg-gray-50 rounded-lg p-3 flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-sm text-gray-700">Strong fundamentals detected</div>
                  </div>
                  <div className="px-4 py-2 bg-green-500/20 border border-green-500/30 rounded-lg">
                    <span className="text-green-600 font-bold text-sm">BUY</span>
                  </div>
                </div>
      ...
      <footer className="border-t border-gray-200 px-6 py-8">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-500 text-sm">Realytics © 2026</span>
          </div>
